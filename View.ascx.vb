...
Public Class View
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        Try
            Dim maincont As New mainController

            Dim dataobj As aj_hero_v1_Info = maincont.getmodueldata(ModuleId)
            If dataobj IsNot Nothing Then
                heroImg.InnerHtml = Server.HtmlDecode(dataobj.Itemblock1)
                heroTxt.InnerHtml = Server.HtmlDecode(dataobj.Itemblock2)

            End If
            testar.InnerHtml = ModuleId
